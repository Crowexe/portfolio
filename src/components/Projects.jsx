...
const Carousel = () => {
    const carouselData = [
        ...
        {
            imageUrl: '/proyectos/01-citas-veterinaria.png',
            text: 'Follow-up of veterinary patients',
            description: 'Application for monitoring patients of a veterinary made with React', 
            link: 'https://01-citas-veterinaria.vercel.app/',
        },
    ];
